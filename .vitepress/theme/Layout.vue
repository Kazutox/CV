<template>
  ...
  <div style="padding: 30px;" class="container">
    <img class="image" src="/resources/banner2.jpg" />
    <div class="header">
      <h1>Jc Cloete - CV</h1>
    ...
    <div class="intro">
      ...
      <a href="mailto:jcccloete97@gmail.com">jcccloete97@gmail.com</a>
...
@media only screen and (max-width: 1200px) {
  .container {
    grid-template:
      ...
      "intro image" 103px
      "content content" 1fr
      / calc(70vw - 265px) 205px !important;
  }
}
...
.container {
  background-color: rgb(218, 217, 206);
  display: grid;
  grid-template:
    "header image" 100px
    "intro image" 103px
